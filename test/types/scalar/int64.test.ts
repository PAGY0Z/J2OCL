...
describe('Int64', () => {
  ...
  it('wraps around like a C int64_t on overflow', () => {
    expect(Int64.of(9223372036854775807n).add(Int64.of(1n))).toEqual(Int64.of(-9223372036854775808n));
  });

  it('subtracts, wrapping around on underflow like a C int64_t', () => {
    expect(Int64.of(5n).sub(Int64.of(3n))).toEqual(Int64.of(2n));
    expect(Int64.of(-9223372036854775808n).sub(Int64.of(1n))).toEqual(Int64.of(9223372036854775807n));
  });

  it('multiplies, wrapping around on overflow like a C int64_t', () => {
    expect(Int64.of(5n).mul(Int64.of(3n))).toEqual(Int64.of(15n));
    expect(Int64.of(9223372036854775807n).mul(Int64.of(2n))).toEqual(Int64.of(-2n));
  });
  ...
  it('negates, wrapping the most negative value back to itself', () => {
    ...
    expect(Int64.of(-9223372036854775808n).negate()).toEqual(Int64.of(-9223372036854775808n));
  });
  ...
  it('compares with greaterThan/lessThan/greaterThanOrEqual/lessThanOrEqual', () => {
    ...
    expect(Int64.of(5n).greaterThanOrEqual(Int64.of(5n))).toEqual(Bool.of(true));
  ...
  it('shifts left, wrapping around on overflow like a C int64_t', () => {
    ...
    expect(Int64.of(4611686018427387904n).shiftLeft(Int64.of(2n))).toEqual(Int64.of(0n));
  });
